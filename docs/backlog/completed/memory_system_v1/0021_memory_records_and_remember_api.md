# Completed: Typed memory records + remember() — semantics-aligned formation
...
Shipped: records.py MemoryRecordInput + remember_many (idempotent formation, verbatim-by-payload_ref, digest as prompt currency, kind vocabulary + ranks, diary form-gates).
