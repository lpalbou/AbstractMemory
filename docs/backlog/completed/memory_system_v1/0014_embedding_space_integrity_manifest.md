# Completed: Embedding-space integrity manifest and shared canonical text
...
Shipped as the M1 embedding pin: model id + DIMENSION recorded at creation/first-write, loud mismatch refusal / labeled vectorless degradation, read_embedding_pin, reembed_store/reembed_home (operator-gated all-or-nothing index swap, journaled act).
