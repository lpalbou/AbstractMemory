# Completed: Stimulus-driven spreading activation + emergent working_set view
...
Shipped: spreading.py — bounded spreading over trail-strengthened edges (ACT-R shape), boost cap <= 12% of a direct hit, working_set emergence from trail + stimulus.
