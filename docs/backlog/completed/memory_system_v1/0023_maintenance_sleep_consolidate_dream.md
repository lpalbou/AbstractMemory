# Completed: sleep() — report-first maintenance, source-preserving consolidation, dream traces
...
Shipped: consolidation.py + maintenance.py + dream_resolution.py — the five-phase sleep_pass (resolution/tending/world_models/mining/dream), fingerprint-idempotent formations, graceful cancellation, novelty gates, and this week the signal stream.
