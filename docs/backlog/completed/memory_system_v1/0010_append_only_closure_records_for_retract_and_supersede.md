# Completed: Append-only closure records for retract and supersede
...
Shipped: close_record (retract/supersede with replacement_ids), closure journal family, closure_exclusions folds applied across every read surface. Never-delete is structural.
