# Completed: World-model orientation cards
...
Shipped: world_model.py — mechanical-card-v2 digests, author_world_model, world_model_update, mention_orientation_cards wired as the orientation channel (reserved admission), alias fold (M3), interests-as-targets + compound discovery (laurent c158/c171), evidence-gist briefings. Live: his interest cards forming on night one (4 formed, watch reading 2).
