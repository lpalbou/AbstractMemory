# Completed: Dream subconscious lifecycle (passive resolution + resurfacing)
...
Shipped: the full dream lifecycle — standing/unresolved semantics (continuation_state incl. continued, P1-1), resolve_dreams_pass (waking evidence disposes, soft closure), disposal verbs, continuation chains, resurfacing metadata (keywords/participants), content-novelty churn gate, contentful digests, and this week attributes.signals (the wave-5 stream). First live firing verified on Ephemeral's first night (room 319/320).
