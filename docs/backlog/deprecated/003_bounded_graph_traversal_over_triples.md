# Deprecated: Bounded graph traversal over triples
...
Superseded by spreading activation (memory_system_v1/0026, shipped): bounded, budgeted, trail-strengthened expansion IS the traversal this item asked for, with better semantics (usage-weighted, not raw edges). probe_expand/expand_by_concepts cover the deliberate-reach case.
