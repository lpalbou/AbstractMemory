# Deprecated: Deterministic anchors and facet indexing
...
Superseded by the shipped channel set: exact/keyword channels + facet_tokens + FTS5 lexical reach + concept anchoring (expand_by_concepts) deliver deterministic recall cues; the anchor-index prototype this item proposed was leapfrogged by the engine wave.
