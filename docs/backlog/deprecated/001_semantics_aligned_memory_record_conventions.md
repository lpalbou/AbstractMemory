# Deprecated: Semantics-aligned memory record conventions
...
## Deprecation (2026-07-20)

Superseded by the ruled 0016 direction (commons c184, 2026-07-10): the seven shipped plain-word relations are admitted as declared terms; CURIEs demote to registry-side equivalence metadata; no new predicate engraves before a coordinated registry declaration. The remaining work lives in proposed/memory_system_v1/0016 with the semantics seat.
